...
function configLoad(){
	...
	if($("#serverHostInput").val()!=""){
		$('#connectionButton').click();
	}
	if(localStorage.getItem("wakeUpFile")){
		$("#wakeUpInputFile").val(localStorage.getItem("wakeUpFile"));
	}
}